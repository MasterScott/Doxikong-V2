...
def banner():
    print(bcolors.Redd + """
      ...
      | $$  | $$| $$  | $$  >$$  $$ | $$| $$\  $$ | $$  | $$| $$  | $$| $$  | $$        \  $$$/  | $$
      | $$$$$$$/|  $$$$$$/ /$$/\  $$| $$| $$ \  $$|  $$$$$$/| $$  | $$|  $$$$$$$         \  $/   | $$$$$$$$
      |_______/  \______/ |__/  \__/|__/|__/  \__/ \______/ |__/  |__/ \____  $$          \_/    |________/
                                                                       /$$  \ $$                           `happy doxing [+] H@x0r
            add me for support ANG#6166                               | $ ANG $/
                                                                       \______/

        \033[1;32m DoxIkong a tool known for d0xing\033[1;35m \033[1;34mBY\033[1;m https://cracked.to/ANG \033[1;33mVersion:\033[1;32m 2 \033[1;35m \033[1;31m Made with love! \033[1;m
  """)

def search():
    RED(f'[Good Luck Hax0r +] Searching for username:{username}')
    time.sleep(0.5)
    print('.......')
    time.sleep(0.5)
    print('.......\n')
    ...
    PURPLE(f'[+] DoxiKong V2 is working give it a second daddy\n')
    time.sleep(0.5)
    print('.......')
    time.sleep(0.5)
    print('.......\n')
    ...
    for url in WEBSITES:
        ...
        if r.status_code == 200:
            ...
            if username in r.text:
                GREEN(f'[DoxIkong] POSITIVE MATCH: Username:{username} - username has been detected in this url')
            else:
                GREEN(f'[DoxIkong] POSITIVE MATCH: Username:{username} - \033[91mtext has NOT been detected in url, could be a FALSE POSITIVE .')
        count += 1

    total = len(WEBSITES)
    RED(f'FINISHED: A total of {count} MATCHES found out of {total} websites.')
